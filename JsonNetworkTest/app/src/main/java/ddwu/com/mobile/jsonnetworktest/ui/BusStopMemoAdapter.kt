...
class BusStopMemoAdapter : RecyclerView.Adapter<BusStopMemoAdapter.MemoHolder>()  {
    private val TAG ="BusStopMemoActivity"
    ...
    class MemoHolder(val memoBinding: ListMemoBinding, listener: OnItemClickListener?) :RecyclerView.ViewHolder(memoBinding.root){
        init{
